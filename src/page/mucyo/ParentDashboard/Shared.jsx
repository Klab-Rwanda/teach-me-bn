      ...
      <aside className="sidebarOpen sidebar">
        ...
        <ul className="sidebar-menu">
          <li className="sidebar-item">
            <Link to="/parentdashboard/report">
              <MdReportProblem className="dashboard-icon" />
              Schools Report
            </Link>
          </li>

          <li className="sidebar-item">
            <Link to="parentdashboard/account">
              <MdAccountBalance className="dashboard-icon" />
              Create account
            </Link>
          </li>
          <li className="sidebar-item">
            <Link to="parentdashboard/manage">
              <GrUserManager className="dashboard-icon" />
              Manage account
            </Link>
          </li>
          <li className="sidebar-item">
            <Link to="parentdashboard/approvedteachers">
              <ImProfile className="dashboard-icon" />
              Teacher Profiles
            </Link>
          </li>
          <li className="sidebar-item">
            <Link to="/parentdashboard/communication">
              <GiSatelliteCommunication className="dashboard-icon" />
              Communication
            </Link>
          </li>
          <li className="sidebar-item">
            <Link to="/parentdashboard/response">
              <MdQuestionAnswer className="dashboard-icon" />
              Booking Response
            </Link>
          </li>
          <li className="sidebar-item">
            <Link to="/parentdashboard/payment">
              <GiSatelliteCommunication className="dashboard-icon" />
              Payment
            </Link>
          </li>
